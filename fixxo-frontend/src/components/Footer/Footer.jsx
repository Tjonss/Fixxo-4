...
<footer className="text-center text-lg-start bg-light ">
  ...
  <section className="border-bottom pt-5">
    ...
    <div className="container text-center text-md-start mt-5">
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <h6 className="fw-bold mb-4">Customer Service</h6>
          <p><a href="#!" className="text-reset text-decoration-none">Help & FAQs</a></p>
          <p><a href="#!" className="text-reset text-decoration-none">Order Lookup</a></p>
          <p><a href="#!" className="text-reset text-decoration-none">Shipping & delivery</a></p>
        ...
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          <h6 className="fw-bold mb-4">Macy´s Credit Card</h6>
          <p><a href="#!" className="text-reset text-decoration-none">Macy´s Card Services</a></p>
          <p><a href="#!" className="text-reset text-decoration-none">Pay Your Credit Card Bill</a></p>
          <p><a href="#!" className="text-reset text-decoration-none">Cardholder Benefits</a></p>
          <p><a href="#!" className="text-reset text-decoration-none">Apply for Macy´s Credit Card</a></p>
        </div>
        
       
        <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 '">
          <h6 className="fw-bold mb-4">Our Stores</h6>
          
            <p><a href="#!" className="text-reset text-decoration-none">Stores & Services</a></p>
            <p><a href="#!" className="text-reset text-decoration-none">Locations & Hours</a></p>
            <p><a href="#!" className="text-reset text-decoration-none">Store Events</a></p>
            <p><a href="#!" className="text-reset text-decoration-none">Catalogs</a></p>
  ...
  <g id="app-store-badge" transform="translate(-44.2 -19)">
    ...
    <path id="Path_21" data-name="Path 21" d="M71.2,38.8a5.8,5.8,0,0,1,2.7-4.7,6.231,6.231,0,0,0-4.5-2.5c-1.9-.2-3.8,1.1-4.7,1.1-1,0-2.5-1.1-4.1-1.1a5.941,5.941,0,0,0-5.1,3.1c-2.2,3.8-.6,9.4,1.5,12.5,1.1,1.5,2.3,3.2,3.9,3.1s2.2-1,4.1-1,2.4,1,4.1,1,2.8-1.5,3.8-3a11.463,11.463,0,0,0,1.7-3.5A5.529,5.529,0,0,1,71.2,38.8Z" fill="#fff"/>
    <path id="Path_22" data-name="Path 22" d="M68.1,29.6a6.2,6.2,0,0,0,1.3-4,5.356,5.356,0,0,0-3.6,1.9,5.057,5.057,0,0,0-1.3,3.8A4.75,4.75,0,0,0,68.1,29.6Z" fill="#fff"/>
    <path id="Path_23" data-name="Path 23" d="M94,50.1H91.8l-1.2-3.8H86.4l-1.1,3.8H83.2l4.2-12.9H90Zm-3.8-5.4-1.1-3.4c-.1-.3-.3-1.2-.7-2.4h0c-.1.5-.3,1.4-.6,2.4l-1.1,3.4Z" fill="#fff"/>
    <path id="Path_24" data-name="Path 24" d="M104.7,45.4a5.325,5.325,0,0,1-1.3,3.8,3.847,3.847,0,0,1-2.9,1.2,2.722,2.722,0,0,1-2.6-1.3h0V54H95.8V44c0-1,0-2-.1-3.1h1.8l.1,1.5h0a3.446,3.446,0,0,1,3.1-1.7,3.225,3.225,0,0,1,2.7,1.3A4.237,4.237,0,0,1,104.7,45.4Zm-2.1,0a3.593,3.593,0,0,0-.6-2.2,2.019,2.019,0,0,0-1.8-.9,2.389,2.389,0,0,0-1.4.5,2.223,2.223,0,0,0-.8,1.3,1.759,1.759,0,0,0-.1.6v1.6a2.523,2.523,0,0,0,.6,1.7,1.99,1.99,0,0,0,1.6.7,2.019,2.019,0,0,0,1.8-.9A3.612,3.612,0,0,0,102.6,45.4Z" fill="#fff"/>
    <path id="Path_25" data-name="Path 25" d="M115.4,45.4a5.325,5.325,0,0,1-1.3,3.8,3.847,3.847,0,0,1-2.9,1.2,2.722,2.722,0,0,1-2.6-1.3h0V54h-2.1V44c0-1,0-2-.1-3.1h1.8l.1,1.5h0a3.446,3.446,0,0,1,3.1-1.7,3.225,3.225,0,0,1,2.7,1.3A4.237,4.237,0,0,1,115.4,45.4Zm-2.1,0a3.593,3.593,0,0,0-.6-2.2,2.019,2.019,0,0,0-1.8-.9,2.389,2.389,0,0,0-1.4.5,2.223,2.223,0,0,0-.8,1.3,1.759,1.759,0,0,0-.1.6v1.6a2.523,2.523,0,0,0,.6,1.7,1.99,1.99,0,0,0,1.6.7,2.019,2.019,0,0,0,1.8-.9A3.612,3.612,0,0,0,113.3,45.4Z" fill="#fff"/>
    <path id="Path_26" data-name="Path 26" d="M127.4,46.5a3.693,3.693,0,0,1-1.1,2.7,4.761,4.761,0,0,1-3.5,1.1,6.182,6.182,0,0,1-3.3-.8l.5-1.7a6.109,6.109,0,0,0,3,.8,2.969,2.969,0,0,0,1.8-.5,1.816,1.816,0,0,0,.6-1.4,1.9,1.9,0,0,0-.5-1.3,5.011,5.011,0,0,0-1.8-1c-2.3-.8-3.4-2.1-3.4-3.7a3.225,3.225,0,0,1,1.2-2.6,4.554,4.554,0,0,1,3.2-1,6.235,6.235,0,0,1,2.9.6l-.5,1.7a4.871,4.871,0,0,0-2.5-.6,2.86,2.86,0,0,0-1.7.5,1.656,1.656,0,0,0-.5,1.2,1.76,1.76,0,0,0,.6,1.3,7.759,7.759,0,0,0,1.9,1,6.746,6.746,0,0,1,2.5,1.6A4.025,4.025,0,0,1,127.4,46.5Z" fill="#fff"/>
    <path id="Path_27" data-name="Path 27" d="M134.2,42.4h-2.3v4.5c0,1.1.4,1.7,1.2,1.7a2.22,2.22,0,0,0,.9-.1l.1,1.6a3.664,3.664,0,0,1-1.6.2,2.352,2.352,0,0,1-1.9-.7,3.4,3.4,0,0,1-.7-2.5V42.4h-1.4V40.8h1.4V39.1l2-.6v2.3h2.3Z" fill="#fff"/>
    <path id="Path_28" data-name="Path 28" d="M144.5,45.4a5.13,5.13,0,0,1-1.2,3.5,4.6,4.6,0,0,1-3.4,1.4,4.223,4.223,0,0,1-3.3-1.4,4.871,4.871,0,0,1-1.2-3.4,4.752,4.752,0,0,1,1.3-3.5,4.441,4.441,0,0,1,3.4-1.4,4.223,4.223,0,0,1,3.3,1.4A5.331,5.331,0,0,1,144.5,45.4Zm-2.2.1a3.8,3.8,0,0,0-.6-2.2,2.191,2.191,0,0,0-3.8,0,4.032,4.032,0,0,0-.6,2.2,3.8,3.8,0,0,0,.6,2.2,2.144,2.144,0,0,0,1.9,1.1,2.265,2.265,0,0,0,1.9-1.1A4.032,4.032,0,0,0,142.3,45.5Z" fill="#fff"/>
    <path id="Path_29" data-name="Path 29" d="M151.2,42.6c-.2,0-.4-.1-.7-.1a2.136,2.136,0,0,0-1.7.8,3.453,3.453,0,0,0-.5,1.8V50h-2.1V43.6a26.222,26.222,0,0,0-.1-2.9h1.8l.1,1.8h.1a3.956,3.956,0,0,1,1-1.5,2.976,2.976,0,0,1,1.5-.5h.5v2.1Z" fill="#fff"/>
    <path id="Path_30" data-name="Path 30" d="M160.4,45a2.219,2.219,0,0,1-.1.9h-6.2A2.583,2.583,0,0,0,155,48a3.221,3.221,0,0,0,2,.7,6.566,6.566,0,0,0,2.5-.4l.3,1.4a7.455,7.455,0,0,1-3.1.6,4.375,4.375,0,0,1-3.4-1.3,4.7,4.7,0,0,1-1.2-3.4,5.625,5.625,0,0,1,1.1-3.5,4,4,0,0,1,3.3-1.5,3.328,3.328,0,0,1,3,1.5A4.2,4.2,0,0,1,160.4,45Zm-1.9-.5a2.934,2.934,0,0,0-.4-1.6,1.8,1.8,0,0,0-1.6-.9,1.943,1.943,0,0,0-1.6.8,3.819,3.819,0,0,0-.6,1.6h4.2Z" fill="#fff"/>
    <path id="Path_31" data-name="Path 31" d="M89.6,29.3a3.253,3.253,0,0,1-1,2.6,4.138,4.138,0,0,1-2.7.8,6.622,6.622,0,0,1-1.5-.1V26.4a9.722,9.722,0,0,1,1.8-.1,3.727,3.727,0,0,1,2.5.7A3.239,3.239,0,0,1,89.6,29.3Zm-1.1,0A2.089,2.089,0,0,0,86.2,27a1.949,1.949,0,0,0-.8.1v4.7h.7a2.445,2.445,0,0,0,1.8-.6A2.707,2.707,0,0,0,88.5,29.3Z" fill="#fff"/>
    <path id="Path_32" data-name="Path 32" d="M95.2,30.3a2.352,2.352,0,0,1-.6,1.7,2.06,2.06,0,0,1-1.7.7,1.865,1.865,0,0,1-1.6-.7,2.708,2.708,0,0,1,0-3.4,2.06,2.06,0,0,1,1.7-.7,1.865,1.865,0,0,1,1.6.7A2.352,2.352,0,0,1,95.2,30.3Zm-1,0a2.016,2.016,0,0,0-.3-1.1.874.874,0,0,0-.9-.5,1.05,1.05,0,0,0-.9.5,2.167,2.167,0,0,0,0,2.2.874.874,0,0,0,.9.5.961.961,0,0,0,.9-.6A1.493,1.493,0,0,0,94.2,30.3Z" fill="#fff"/>
    <path id="Path_33" data-name="Path 33" d="M102.9,28l-1.4,4.6h-.9l-.6-2a8.331,8.331,0,0,1-.4-1.5h0a8.33,8.33,0,0,1-.4,1.5l-.6,2h-.9L96.2,28h1l.5,2.2.3,1.5h0c.1-.4.2-.9.4-1.5L99,28h.8l.6,2.1a8.331,8.331,0,0,1,.4,1.5h0l.3-1.5.6-2.1Z" fill="#fff"/>
    <path id="Path_34" data-name="Path 34" d="M108.1,32.6h-1V30q0-1.2-.9-1.2a.908.908,0,0,0-.7.3,1.136,1.136,0,0,0-.3.8v2.7h-1V28h.9v.7h0a2.651,2.651,0,0,1,.5-.6,1.613,1.613,0,0,1,.9-.3,1.5,1.5,0,0,1,1.1.4,1.721,1.721,0,0,1,.5,1.5Z" fill="#fff"/>
    <path id="Path_35" data-name="Path 35" d="M110.9,32.6h-1V25.9h1Z" fill="#fff"/>
    <path id="Path_36" data-name="Path 36" d="M116.9,30.3a2.352,2.352,0,0,1-.6,1.7,2.06,2.06,0,0,1-1.7.7A1.865,1.865,0,0,1,113,32a2.708,2.708,0,0,1,0-3.4,2.413,2.413,0,0,1,1.7-.7,1.865,1.865,0,0,1,1.6.7A2.352,2.352,0,0,1,116.9,30.3Zm-1,0a2.016,2.016,0,0,0-.3-1.1.874.874,0,0,0-.9-.5,1.05,1.05,0,0,0-.9.5,2.167,2.167,0,0,0,0,2.2.874.874,0,0,0,.9.5.961.961,0,0,0,.9-.6A1.493,1.493,0,0,0,115.9,30.3Z" fill="#fff"/>
    <path id="Path_37" data-name="Path 37" d="M121.8,32.6h-.9l-.1-.5h0a1.612,1.612,0,0,1-1.3.6,1.159,1.159,0,0,1-1-.4,1.8,1.8,0,0,1-.4-.9,1.357,1.357,0,0,1,.7-1.3,3.737,3.737,0,0,1,2-.4v-.1a.8.8,0,0,0-.9-.9,2.375,2.375,0,0,0-1.2.3l-.2-.7a2.537,2.537,0,0,1,1.6-.4c1.2,0,1.8.6,1.8,1.9v1.7A4.907,4.907,0,0,0,121.8,32.6Zm-1-1.6v-.7c-1.1,0-1.7.3-1.7.9a.684.684,0,0,0,.7.7,1.421,1.421,0,0,0,.6-.2,1,1,0,0,0,.4-.5Z" fill="#fff"/>
    <path id="Path_38" data-name="Path 38" d="M127.6,32.6h-.9v-.7h0a1.476,1.476,0,0,1-1.5.8,1.816,1.816,0,0,1-1.4-.6,2.311,2.311,0,0,1-.5-1.7,2.792,2.792,0,0,1,.6-1.8,1.974,1.974,0,0,1,1.4-.6,1.486,1.486,0,0,1,1.3.6h0V26h1v6.6Zm-1-1.9V29.6a2.092,2.092,0,0,0-.4-.6.844.844,0,0,0-.7-.2,1.05,1.05,0,0,0-.9.5,2.133,2.133,0,0,0-.3,1.2,1.8,1.8,0,0,0,.3,1.1,1.05,1.05,0,0,0,.9.5.909.909,0,0,0,.8-.4A2.236,2.236,0,0,0,126.6,30.7Z" fill="#fff"/>
    <path id="Path_39" data-name="Path 39" d="M136.3,30.3a2.352,2.352,0,0,1-.6,1.7,2.06,2.06,0,0,1-1.7.7,1.865,1.865,0,0,1-1.6-.7,2.708,2.708,0,0,1,0-3.4,2.06,2.06,0,0,1,1.7-.7,1.865,1.865,0,0,1,1.6.7A2.352,2.352,0,0,1,136.3,30.3Zm-1.1,0a2.016,2.016,0,0,0-.3-1.1.874.874,0,0,0-.9-.5,1.05,1.05,0,0,0-.9.5,2.167,2.167,0,0,0,0,2.2.874.874,0,0,0,.9.5.961.961,0,0,0,.9-.6A1.493,1.493,0,0,0,135.2,30.3Z" fill="#fff"/>
    <path id="Path_40" data-name="Path 40" d="M141.8,32.6h-1V30q0-1.2-.9-1.2a.908.908,0,0,0-.7.3,1.136,1.136,0,0,0-.3.8v2.7h-1V28h.9v.7h0a2.652,2.652,0,0,1,.5-.6,1.613,1.613,0,0,1,.9-.3,1.5,1.5,0,0,1,1.1.4,1.721,1.721,0,0,1,.5,1.5Z" fill="#fff"/>
    <path id="Path_41" data-name="Path 41" d="M148.6,28.8h-1.1V31c0,.6.2.8.6.8h.5v.8a1.949,1.949,0,0,1-.8.1.975.975,0,0,1-.9-.4,1.922,1.922,0,0,1-.3-1.2V28.8h-.7V28h.7v-.8l1-.3V28h1.1v.8Z" fill="#fff"/>
    <path id="Path_42" data-name="Path 42" d="M154,32.6h-1V30q0-1.2-.9-1.2a.963.963,0,0,0-1,.7v3.1h-1V25.9h1v2.8h0a1.6,1.6,0,0,1,1.4-.8,1.159,1.159,0,0,1,1,.4,2.25,2.25,0,0,1,.5,1.5Z" fill="#fff"/>
    <path id="Path_43" data-name="Path 43" d="M159.5,30.1v.5h-3a1.333,1.333,0,0,0,.4,1,1.689,1.689,0,0,0,1,.3,3.73,3.73,0,0,0,1.2-.2l.2.7a3.339,3.339,0,0,1-1.5.3,2.409,2.409,0,0,1-1.7-4,1.865,1.865,0,0,1,1.6-.7,1.579,1.579,0,0,1,1.5.7A2.649,2.649,0,0,1,159.5,30.1Zm-.9-.3a1.884,1.884,0,0,0-.2-.8.812.812,0,0,0-.8-.4.909.909,0,0,0-.8.4,1.136,1.136,0,0,0-.3.8Z" fill="#fff"/>
  </g>
</svg>
  ...
  <g id="google-play-badge" transform="translate(-185.5 -18.5)">
    ...
    <path id="Path_72" data-name="Path 72" d="M243.6,31.4V25.8h1v5.6Z" fill="#fff"/>
    <path id="Path_73" data-name="Path 73" d="M247.3,31.4V26.7h-1.7v-.9H250v.9h-1.7v4.7h-1Z" fill="#fff"/>
    <path id="Path_74" data-name="Path 74" d="M253.2,28.6a2.9,2.9,0,1,1,2.9,2.9A2.84,2.84,0,0,1,253.2,28.6Zm4.7,0a1.813,1.813,0,0,0-1.9-2,1.923,1.923,0,0,0-1.9,2,1.813,1.813,0,0,0,1.9,2A1.864,1.864,0,0,0,257.9,28.6Z" fill="#fff"/>
    <path id="Path_75" data-name="Path 75" d="M264,31.4l-2.9-4v4h-1V25.8h1l2.9,3.9V25.8h1v5.6Z" fill="#fff"/>
  </g>
</svg>
                ...
                <div className=" mt-3">
                    ...
                    <a href="#!" className="me-4 text-reset"><i className="fab fa-linkedin"></i></a></div>
              </div>
        </div>
  ...
  {/* < className="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);"> */}
